...
//ErrAlreadyExist : request doesn't change anything in database since there are already exist the ecludind record
var ErrAlreadyExist = errors.New("User with this username/email already exist")

//ErrPasswordFormat : request doesn't change anything in database since there are already exist the ecludind record
